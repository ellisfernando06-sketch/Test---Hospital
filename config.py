...
if not TOKEN:
    raise ValueError("No se encontró el TOKEN. Configúralo en las Variables de Railway.")
...
#    Formato: key: ("Nombre exacto del rol en Discord", "#COLOR_HEX")
# ---------------------------------------------------------------------------
KEYS_NOMBRES = {
    "OWNER":                ("👑 Owner", "#E74C3C"),
    "CO_OWNER":             ("Co-Owner", "#C0392B"),
    "ENCARGADO_DISCIPLINA": ("Encargado de Disciplina", "#8E44AD"),
    "JEFE_JUNTA_DIRECTIVA": ("Presidente del Consejo", "#9B59B6"),
    ...
    "DIRECTOR_SEGURIDAD":   ("Director de Seguridad", "#34495E"),
...
# ---------------------------------------------------------------------------
# 4) CANALES DE LOG (pon el ID numérico del canal o deja None)
# ---------------------------------------------------------------------------
CANALES = {
    "log_general":        None,
    "log_roles":          None,
    ...
    "alerta_codigos":     None,
    "bot_status":         1481762625279758449,   # Canal donde se publica el estado del bot (Online / Mantenimiento / Offline)
}

# ---------------------------------------------------------------------------
# 5) PACIENTES E INVENTARIO
# ---------------------------------------------------------------------------
